      ...
      {product ? (
        <div className="flex flex-col md:flex-row items-center justify-between bg-white rounded-xl shadow-2xl p-6 md:p-10 ">
          ...
          <div className="md:w-2/3 md:ml-8">
            <h2 className="text-3xl font-semibold text-gray-900 mb-4"><b>Nomi:</b> {product.title}</h2>
            <h3 className="text-lg font-medium text-gray-700 mb-3"><b>Pages:</b> {product.pageCount}</h3>
            <p className="text-gray-600 leading-relaxed"><b>Description:</b> {product.longDescription || 'No description available'}</p>
          </div>
        </div>
      ) : (
